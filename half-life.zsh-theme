...
add-zsh-hook precmd kubectl_precmd
...
setopt prompt_subst
PROMPT="${purple}%n%{$reset_color%} in ${limegreen}%~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_ ${hotpink} \$kubectl_context ${orange}λ%{$reset_color%} "
